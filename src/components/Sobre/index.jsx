...
import imgsobre from "/src/assets/imgsobre.png";
  ...
  return (
    <div className="flex flex-col items-center p-6">
      ...
      <p className="text-center mb-8">
        Que tal conhecer um pouco mais do evento? Entenda nossa missão e o papel
        da enfermagem na assistência obstétrica.
      </p>
          ...
          <div className="flex flex-col items-start p-6 border-2 border-gray-200 rounded-lg w-full md:w-[500px]">
            ...
            <p className="text-left mb-4">
              ...
              {expandedSection === "mission" && (
                <>
                  {" "}
                  Nosso foco é promover habilidades e conhecimentos que permitam
                  aos profissionais de saúde prestar uma assistência de
                  qualidade, com ética e sensibilidade às necessidades dos
                  pacientes.
                </>
              )}
            </p>
            ...
            <p className="text-left mb-4">
              ...
              {expandedSection === "role" && (
                <>
                  ...
                  uma assistência contínua e segura, promovendo o bem-estar e a
