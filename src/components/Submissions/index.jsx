    ...
    <div className="flex flex-col max-h-[802px] max-w-7xl mx-auto px-4">
      <div className="mb-7 flex flex-col">
        ...
        <p className="text-lg text-center p-7">
          Contribua para o avanço das novas perspectivas no campo da enfermagem,
          participando das discussões no SIEGEPAN. Este simpósio reúne
          profissionais da saúde e pesquisadores para debater abordagens
          inovadoras no cuidado à gestação, parto e nascimento. Junte-se a nós e
          ajude a transformar práticas de saúde.
        </p>
      </div>
      <div className="h-[900px]">
        {windowSize.width > 640 ? <HorizontalTimeLine /> : <VerticalTimeLine />}
      </div>
      <div className="mt-20">
