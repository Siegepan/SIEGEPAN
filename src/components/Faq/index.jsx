  ...
  const faqItems = [
    {
      ...
      answer: "O evento acontecerá dos dias 5 a 7 de dezembro, no auditório do Instituto de Computação (IC).",
      icon: grupo,
    },
    { question: "Como realizo minha inscrição?", answer: "", icon: register },
    { question: "Haverá emissão de certificado para os participantes?", answer: "", icon: certificado },
    { question: "A participação é gratuita?", answer: "", icon: money },
    { question: "Onde posso submeter meu trabalho?", answer: "", icon: grafico },
    { question: "Como consigo entrar em contato com a organização?", answer: "", icon: phone },
  ];

  return (
    <div className="w-full h-full p-14">
      <div className="flex items-center mb-4">
        <img src={planta} alt="Planta" style={{ width: "48px", height: "48px", marginRight: "8px" }} />
        <h2 className="text-2xl font-bold">Perguntas Frequentes</h2>
      </div>
      <p className="mb-8">
        Precisa de informações? Encontre sua resposta sobre os detalhes do evento aqui!
          ...
          <div key={index}>
            ...
            >
              <div className="flex items-center">
                <img src={item.icon} alt="Ícone" style={{ width: "32px", height: "32px", marginRight: "12px" }} />
